...
const App = () => {
  const [item, setItem] = useState({ slip: {} })
  ...
  return (
    <div className='container'>
      <h1>Advice #{item.slip.id}</h1>
      <p>"{item.slip.advice}"</p>
      <svg className='desktop' width="444" height="16" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className='mobile' width="295" height="16" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
      ...
      <div className='dice' onClick={handleDiceClick}>
        <svg className='diceIcon' width="24" height="24" xmlns="http://www.w3.org/2000/svg">
